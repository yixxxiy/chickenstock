...
const RANKS := [
	{"lv": 1, "min": 0, "title": "流浪小鸡", "copy": "口袋空空，八日收场有点潦倒。"},
	{"lv": 2, "min": 300, "title": "见习股民", "copy": "刚摸到股市门槛，还得精打细算。"},
	{"lv": 3, "min": 600, "title": "咯咯佃农", "copy": "农场能转了，但还谈不上宽裕。"},
	{"lv": 4, "min": 1000, "title": "小本鸡舍", "copy": "有点积蓄，在动物街站稳了脚跟。"},
	{"lv": 5, "min": 1500, "title": "温饱农场", "copy": "日子过得去，离新贵还差一截。"},
	{"lv": 6, "min": 2000, "title": "街口商贩", "copy": "买卖开始像样，邻居开始打听你。"},
	{"lv": 7, "min": 2500, "title": "农场掌柜", "copy": "鸡舍和股市两边都能转。"},
	{"lv": 8, "min": 3000, "title": "动物街新贵", "copy": "资产过三千，真正在街上扬名。"},
	{"lv": 9, "min": 4500, "title": "金币大亨", "copy": "股价和农场都听你的。"},
	{"lv": 10, "min": 6000, "title": "农场传奇", "copy": "八日登顶，动物街都会记得你。"},
]
...
func _process(delta: float) -> void:
	...
	if pending_eggs > 0 and left_ms > 0:
		var wait := clampf((left_ms - 1400.0) / maxf(1.0, float(pending_eggs)), 900.0, 2800.0) / 1000.0
...
func _save() -> void:
	...
	var d := {
		...
		"shares": shares, "price": price, "day": day, "leftMs": left_ms,
